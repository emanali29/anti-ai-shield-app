...
# 1. Advanced 10-Step Mathematical PGD Shield for Images
...
with tab1:
    ...
    if uploaded_image is not None:
        ...
        with col2:
            ...
            st.download_button(label="📥 Download Vaccinated Photo", data=encoded_img.tobytes(), file_name="eman_vaccinated_photo.png", mime="image/png")
...
with tab2:
    ...
    if uploaded_video is not None:
        ...
        with open(output_path, "rb") as f:
            st.download_button(label="📥 Download Vaccinated Video", data=f.read(), file_name="eman_vaccinated_video.mp4", mime="video/mp4")
